...
| [Enterprise Platform Authentication Broker API](PlatformAuthentication/explainer.md) | <a href="https://github.com/MicrosoftEdge/MSEdgeExplainers/labels/PlatformAuthentication">![GitHub issues by-label](https://img.shields.io/github/issues/MicrosoftEdge/MSEdgeExplainers/PlatformAuthentication?label=issues)</a> | [New issue...](https://github.com/MicrosoftEdge/MSEdgeExplainers/issues/new?assignees=coder-linping&labels=PlatformAuthentication&template=platform-authentication-api.md&title=%5BPlatform+Authentication+API%5D+%3CTITLE+HERE%3E) | JavaScript |
