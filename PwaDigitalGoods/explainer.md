...
### Product type 
The Microsoft Store supports four add-on types: Durable, Developer-managed consumable, Store-managed consumable and Subscription. But Digital Goods API only have two kinds of `ItemType`. So currently we only support Developer-managed Consumable as "product", and Durable as "subscription".
### Purchase management
